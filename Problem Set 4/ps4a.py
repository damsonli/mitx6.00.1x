...
WORDLIST_FILENAME = "C:/code/MITx 6.00.1x/Problem Set 4/words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    for letter in word_dict:
        result = result and (word_dict[letter] <= hand.get(letter,0))
    
    result = result and (word in wordList)
    return result
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"' + user_input + '" earned', getWordScore(user_input, n), 'points.', \
                'Total:', total, 'points')
                print()
                # Update the hand 
