'''
Write an iterative function iterPower(base, exp) that calculates the exponential base(exp) by simply 
using successive multiplication. For example, iterPower(base, exp) should compute base(exp) by multiplying 
